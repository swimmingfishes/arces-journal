...
export function LandingSearch({ searchQuery, onSearchChange }: LandingSearchProps) {
  return (
    <section className="w-full page-gutter-narrow pt-6 md:pt-8 pb-0 relative">
      {/* Siluet dari bawah */}
      ...
      <div className="mx-auto px-8 relative z-10">
        <form onSubmit={(e) => e.preventDefault()}>
          <InputGroup className="h-10 md:h-20 backdrop-blur-md bg-white/40 dark:bg-white/5 border-0 border-b border-border/60  shadow-sm rounded-xl">
